	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "مُنشئ جولة الخريطة غير مدعوم في هذا الحجم من العرض.",
			...
			builderHTML: {
				...
				dataExplain: "سيتم إنشاء طبقة معالم جديدة للصور ونقاط الجولة. لن يتم مشاركة الطبقة مع أي مستخدم إلا بعد مشاركة جولة الخريطة.",
			...
			initPopupHome: {
				...
				hostedFsNA2: "متوفر فقط لعضو ArcGIS Online for Organizations <a href=\'%LINK%\'>اشترك للاستمتاع بفترة تجريبية مجانية</a>",
