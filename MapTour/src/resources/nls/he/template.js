define({
  "viewer": {
    ...
    "builderHTML": {
      ...
      "dataExplainPortal": "ישות זו דורשת פורטל עבור ArcGIS 10.4. אם אינך מצליח ליצור את שכבת הישות, צור קשר עם מנהל ArcGIS.",
      "dataNameLbl": "שם שכבה",
      ...
      "coverPreview": "כדי לראות את השער, שמור את הסיפור שלך ולאחר מכן צפה שתצוגה מקדימה שלו באמצעות הלחצן 'שתף'."
    },
    "addPopupJS": {
    ...
    "viewPicasa": {
      "title": "יבוא מ-Picasa",
      "header": "הזן את כתובת הדוא\"ל או את Picasa ID שלך.",
      "userInputLbl": "אמייל או Picasa ID",
      "signInMsg2": "חשבון לא נמצא",
      "signInMsg3": "אין אלבום ציבורי",
      "howToFind": "כיצד למצוא Picasa ID?",
    ...
    "viewGeoTag": {
      ...
      "headerExplain": "אם התמונות שלך כוללות מיקום מרחבי חוקי, הן יאותרו באופן אוטומטי במפה ויופיעו ברשימה שבלשונית השנייה.‎<br /><br />‎כברירת מחדל, Picasa ו-Flickr לא שומרים את המטה-דאטה מסוג EXIF של המיקום המרחבי כשאתה מייבא תמונות. בדוק את הגדרות הפרטיות של Picasa/Flickr כדי לאפשר ייבוא ושימוש במיקום מרחבי של תמונות על-ידי יישום חיצוני. ייתכן שתצטרך לייבא שוב את התמונות הקיימות שלך אל Flickr/Picasa כדי שהמיקום המרחבי מסוג EXIF ייכנס לשימוש.",
    ...
    "helpPopup": {
      ...
      "tab1": {
        ...
        "mtFAQ": "<a href='https://storymaps.arcgis.com/en/faq/#category4' target='_blank'>סיור במפה - שאלות נפוצות.</a>",
      ...
      "tab2": {
        ...
        "div11": "אם תבחר לארח את התמונות בעצמך, תצטרך ליצור באופן ידני תמונות ממוזערות של התמונות שלך. שימוש בתמונות ברזולוציה מלאה עבור התמונה הממוזערת יגרום לביצועים ירודים. ראה <a href='https://links.esri.com/storymaps/faq_maptour_image_size' target='_blank'>שאלה נפוצה</a> זו לקבלת עצות לשינוי גודל התמונות שלך אם בכוונתך לגשת אליהן באינטרנט באמצעות כתובות URL.",
      ...
      "tab4": {
        ...
        "div1": "תמונות",
        "div2": "למרות שניתן להשתמש בסיור במפה אחד בתמונות בגדלים, צורות וכיוונים שונים, אנו ממליצים להשתמש בתמונות לרוחב ולא לאורך. תמונות ביחס רוחב-גובה של 4:3 הן המתאימות ביותר. בפריסות 'שלוש חלוניות' ו'משולבת', שבהן הכיתוב חופף לתמונה, שימוש בתמונות לאורך יכול לגרום להסתרת חלק גדול מהתמונה על-ידי הכיתוב. בפריסות 'שלוש חלוניות' ו'משולבת', מומלץ להשתמש במידת האפשר בתמונות בעלות גודל וצורה זהים. כך, דעתו של המשתמש לא תוסח על-ידי תמונות בגדלים שונים במהלך הסיור.",
        ...
        "div12": "הימנע משימוש ב-iFrame ברוחב צר שיגרום לסיור במפה לעבור לפריסה תגובתית מבוססת מגע המיועדת למסך קטן. כדי להקל את השימוש ככל האפשר, כשתטביע סיור במפה, מומלץ לספק תמיד קישור לצד הסיור המוטבע, כדי לאפשר למשתמשים להפעיל את הסיור במסך מלא."
      },
      "tab5": {
        "title": "פירסום",
    ...
    "share": {
      ...
      "manageStoryA1": "טיפ: באפשרותך להשתמש ב-‎%LINK1% כדי לבדוק אם קיימות שגיאות בסיפור שלך וכדי לשנות את אופן שיתוף הרכיבים. 'הסיפורים שלי' גם מסייע לך לשפר את מראה הסיפור שלך כשהוא משותף ברשתות חברתיות. באפשרותך ללמוד אודות ישויות שימושיות אחרות של 'הסיפורים שלי' ב-‎%LINK2% אלה.",
      "manageStoryA1V1": "הסיפורים שלי",
      "manageStoryA1V2": "פרסומים בבלוג",
    ...
    "httpsTransitionNotification": {
      ...
      "s1p1": "מפות הסיפור שלך חיות באינטרנט, וקהילת האינטרנט פועלת לשיפור האבטחה וליישום תקנים משופרים. פרוטוקול HTTPS, המספק חיבור מאובטח לתוכן המשודר באינטרנט, הופך לדרך המקובלת של גישה אל תוכן באינטרנט. רוב הדפדפנים המודרניים מציגים כעת הודעות אזהרה כאשר נעשה שימוש ב-HTTP במקום ב-HTTPS. בשל תקן זה, הצובר תאוצה, החל מהעדכון של יוני 2018 ל-ArcGIS Online, מפות הסיפור שלך יצטרכו לעשות שימוש ב-HTTPS.",
      "s1p2": "מבחינה מעשית, פירוש הדבר שהגישה אל מפת סיפור וכל התוכן שלה (כולל תמונות, שכבות, אפליקציות מוטבעות ואתרי אינטרנט) חייבת להתבצע מקישורים המתחילים ב-HTTPS ולא ב-HTTP. הדבר מבטיח את החוויה הטובה ביותר לקוראים שלך, משום שרוב דפדפני האינטרנט יציינו שהסיפורים שלך אינם מאובטחים.",
      "s2h1": "מה עלי לעשות?",
      "s2p1": "Esri פועלת כדי להקל על המחברים והקוראים של מפות סיפור לבצע את המעבר. באשף הבנייה של 'מפת סיפור' וב'הסיפורים שלי', העמדנו לרשותך כלים שיסייעו לך לזהות תוכן לא מאובטח (HTTP) בסיפורים שלך ויספקו המלצות לטיפול במצב. עליך לבדוק את הסיפורים שלך לאיתור תוכן לא מאובטח ועדכן ל-HTTPS לפני יוני 2018.",
      "action1": "סגור",
