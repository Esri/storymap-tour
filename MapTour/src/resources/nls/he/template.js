  ...
  "viewer": {
    ...
    "helpPopup": {
      ...
      "tab2": {
        ...
        "div11": "אם תבחר לארח את התמונות בשרת שלך (במקום לגשת לתמונות ב-Flickr או להעלות אותן ישירות לסיור שלך), תצטרך ליצור תמונות ממזערות שלהן באופן ידני. שימוש בתמונות ברזולוציה מלאה עבור התמונה הממוזערת יגרום לפגיעה בביצועים. ראה ‎<a href='https://links.esri.com/storymaps/faq_maptour_image_size' target='_blank'>‎שאלה נפוצה‎</a>‎ לקבלת עצות בנוגע לשינוי גודל התמונות אם בכוונתך לגשת אליהן ישירות באינטרנט באמצעות כתובות URL.",
        "div12": "שימוש בנתוני מקומות קיימים",
        "div13": "אם יש לך נתוני מקומות קיימים, כמו רשימה של מקומות בגיליון נתונים או שכבת נקודות GIS, תוכל להשתמש בנתונים אלו בפורמט CSV כדי ליצור סיור במפה. לשם כך, התמונות שלך צריכות להיות זמינות דרך כתובות URL שמאוחסנות בצורה של ערכים בקובץ CSV. ניתן להוריד את תבנית ה-CSV מהאפשרויות המתקדמות כאשר תפעיל לראשונה את הכלי ליצירת סיור במפה. ניתן להעלות את קובץ ה-CSV דרך החלון.",
        ...
        "div174": "ראה את <a href='https://links.esri.com/storymaps/faq_map_tour_gis_data' target='_blank'>השאלה הנפוצה</a> לקבלת מידע נוסף.",
        ...
        "div21": "אם אתה ניגש לתמונות ב-Flickr, הסיור במפה ניגש לתמונות אלה כקובצי ‎.jpg באופן אוטומטי. אם תעלה תמונות אל אשף הבנייה של 'סיור במפה', התמונות חייבות להיות בתבנית ‎.jpg או ‎.jpeg אם תפנה אל תמונות באופן ישיר באינטרנט באמצעות כתובות ה-URL שלהן, תבניות התמונה הנתמכות הן ‎.jpg, ‏‎.jpeg, ‏‎.png, ‏‎.gif ו-‎.bmp סרטוני YouTube נתמכים באופן ישיר.",
