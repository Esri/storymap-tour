...
({
		viewer: {
			...
			errors: {
				...
				oldBrowserExplain3: "בונה הסיור הממופה לא עובד עם אינטרנט אקספלורר 10 על Windows XP.",
			...
			builderHTML: {
				...
				addLabelPicUrl: "כתובת URL של תמונה",
				addLabelThumbUrl: "כתובת URL תמונה ממוזערת",
				addTextPlaceholderUrl: "הכנס URL",
				addLabelName: "שם",
			...
			addPopupJS: {
				...
				errorInvalidPicUrl: "הכנס URL תקין של תמונה עבור נקודת הסיור הנוכחית",
				errorInvalidThumbUrl: "הכנס URL תקין של תמונה ממוזערת עבור נקודת הסיור הנוכחית",
			...
			importPopupHome: {
				...
				loadCSV: "יש עבורם התייחסות ב-CSV (כל תמונה שחולקת שירות או שרת, הצג עזרה לקבלת פרטים נוספים)",
				loadFolder: "תיקיה במחשב שלי (לכך נדרש דפדפן מודרני ושירות ישויות עם מקורות מידע מקושרים)"
			},
			...
			viewFacebook: {
				header: "בצע אימות מול חשבון משתמש בפייסבוק או בעמוד ציבורי. ניתן להשתמש באלבומים פרטיים בכדי ליצור סיור ממופה ציבורי שלא ידרוש אימות עם חשבון משתמש של פייסבוק, וזה יאפשר לשמור הערות ולייקים כפרטיים.",
			...
			viewPicasa: {
				...
				howToFind2: "העתק תווין בין ה /'//' הראשון לשני של כל עמוד Picasa או G+"
			},
			viewCSV: {
			...
			initPopupHome: {
				...
				footer2: "עזרה בייעוץ בסיור הממופה",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "התבנית מייצגת אפליקצית אינטרנט אטרקטיבית ונוחה לשימוש, המאפשרת לך להציג סט נבחר של מקומות על ברצף ממוספר שדרכו משתמשים יכולים לדפדף. התבנית מעוצבת כך שניתן יהיה להשתמש בה בכל בכל דפדפן אינטרנט או כל מכשיר, כולל סמארטפונים וטאבלטים.",
					div3: "העזרה תכוון אותך צעד אחר צעד בפרסום הסיור הממופה דוגמת:",
				...
				tab2: {
					title: "מידע",
					div1: "הנושא המרכזי ששווה לשקול כאשר בונים סיור ממופה הוא בחירה היכן התמונות שלך יאוחסנו. סיור ממופה יכול להשתמש בתמונות המאוחסנות בשירותי שיתוף תמונות גדולים, בכל שרת אינטרנט או בשירותי ישויות.",
					div2: "הבונה האינטראקטיבי נותן לך שתי אפשרויות לניהול התמונות בסיור הממופה שלך:",
					div3: "<ul><li>ניתן להשתמש <b>בתמונות מהאינטרנט </b>או מאתרי שיתוף כגון,  Flickr או מתמונות המאוחסנות באתר שלך. תמונות אלו יקושרו לסיור הממופה באמצעות ה-URLs שלהם</li><li>ניתן גם <b>לטעון תמונות מהמחשב האישי שלך </b> ישירות לסיור הממופה. אופציה זו דורשת שיהיה לך חשבון מנוי ארגוני של ArcGIS ושתהיינה לך הרשאות פרסום או אדמיניסטרציה (מכיוון שאוטומטית נוצר עבורך שירות ישויות מתארח שבו מאוחסנות התמונות שלך קקישורים) </li></ul>",
					div4: "השימושים העיקריים הם:",
					div4b: "<b>התמונות שלך לא מאוחסנות</b>עדיין ויש לך חשבון ארגוני: שימוש בשירות ישויות מאוחסן היא הבחירה הטובה ביותר עבורך. בדומה לשירותי שיתוף תמונות ציבורי, נוכל למקסם את התמונות שלך בכדי ליצור טעינת תמונות ולך תהיה גישה לכל יכולות ניהול הנתונים והמינהלה של פלטפורמת ה- ArcGIS",
					div5: "<b>אינך חלק מארגון</b>: תחילה עליך לטעון את התמונות שלך לאתר שיתוף תמונות או לשרת האינטרנט שלך. לאחר מכן האשף יסייע לך להשתמש בתמונות הללו שימשיכו להיות מאוחסנים במיקום המקורי שלהם.",
					div6: "<b>הינך מנסה להשתמש מחדש בשירות ישויות</b> המאחסן את התמונות שלך כקישורים או המתייחס לתמונות ממקור חיצוני: התחשב בחלק המפורט שלהלן",
					div7: "<b>אתה משתמש בגרסה הקודמת</b> של תבנית הסיור הממופה וכבר יש לך קובץ CSV המקשר לתמונות והתמונות הממוזערות שלך: תוכל לייבא זאת וללטש את הנתונים שלך. האשף תומך רק ב- CSV המשתמש במאפייני אורך/רוחב, ניתן יהיה להשתמש בכתובת מבוססת CSV ב- web map שלך (ראה חלק להלן)",
					div8: "מייבא מתוך שירותי שיתוף תמונות מקוונים",
					div9: "פעולת הייבוא כבר מתייחסת לתמונות על ידי איחסון ה- URL שלהן ב- web map feature collection. התמונות אינן מאוחסנות ב- ArcGIS Online. אם איחסון תמונות לא תקין, הן לא יהיו זמינות בסיור הממופה ותמונה של //"תמונה לא זמינה//" תופיע. בהסתמך על ספק השירותים, סיור ממופה ייבא את השם, התיאור והמיקום של התמונות. מאפיינים אלה מאוחסנים ב- web map וכל עריכה בשירותים המקוונים לא תשתקף בסיור הממופה.",
					div10: "איחסון התמונות בשרת אינטרנט",
					div11: "באם תבחר לארח את התמונות שלך בעצמך, תתבקש ליצור באופן ידיני תמונות ממוזערות עבור התמונות שלך. שימוש בתמונות ברזולוציה מלאה עבור התמונה הממוזערת יביא לתוצאה של ביצועים לא טובים. לפיכך, אנו ממליצים בחום שתשתמש בשירותי שיתופי תמונות מקוונים או שירות ישויות שיבצע זאת עבורך.",
					div12: "משתמש בשירות ישויות קיים או Shapefile",
					div13: "כל שירות ישויות נקודתי או Shapefile יכול לשמש כמקור נתוני סיור ממופה. עליך רק להוסיף את השכבה לתוך ה- web map שלך באמצעות צפיין מפה של ArcGIS.com. אם האפליקציה תמצא מאפיינים צפויים בשכבה שלך, כל היכולות של הבונה יהיו זמינות עבורך.",
					...
					div16: "שדות שם ותיאור הינם חובה. אם האפליקציה לא תמצא שדות תואמים בעת שימוש בשירות ישווית, הצפיין לא יעבוד עד אשר תגדיר את תצורת השדות לשימוש באמצעות הבונה. יש לכלול את כל השדות הנדרשים בקובץ CSV ושכבת Shapefile שיתווספו ל-  web map באם ברצונך שהבונה יעבוד.",
					div17: "שדות התמונה והתמונה הממוזערת הינם חובה עבור שירות הישויות ללא קישורים ואופציונליים אך ממולצים בחום עבור שירות ישויות עם קישורים. אם יש בשירות שלך קישורים פתוחים לשימוש, הבונה יאפשר לך לטעון אותם כקישורים. באם לא, תוכל רק לערוך את כתובת ה- URL של התמונה והתמונה הממוזערת.",
					div18: "יוצר שירותי ישויות מתארחים מתוך קובץ CSV או Shapefile",
					div19: "שר אתה יוצר שירות ישויות מתארח מתוך קובץ CSV או Shapefile, הקישורים לא פתוחים לפעולה על פי הגדרת ברירת מחדל. פתח את עמוד הפריט של שירות הישויות, לחץ על החץ הקטו בחלק השכבה ותראה שם את האפשרות. לאחר מכן, הסיור הממופה ימשיך להשתמש בתמונות והתמונות הממוזערות שקישרת אותם באמצעות המאפיינים. ישנה אפשרות נוספת לטעון את התמונות כשירות ישויות עם קישורים ואת זאת תוכל לבצע באמצעות שני כפתורים בפאנל התמונה (שנה תמונה ושנה תמונה ממוזערת).",
				},
				tab3: {
					title: "התאמה",
					div1: "הבונה מספק מספר אפשרויות התאמה הנגישות באמצעות כפתרו ההגדרות בחלק העליון של הפאנל. אם לא מצאת את האפשרות אותה הינך מחפש, אנו מספקים גם גרסה ברת הורדה שבאפשרותך לפרוס בשרת האינטרנט שלך ולשדרג אותה כדי שתתאים לצרכייך.",
					...
					div4: "הגרסה הזמינה להורדה לא מציעה את הבונה האינטראקטיבי. הסיור הממופה יקבל את הנתונים שלו מתוך ה- web map והגדרת התצורה מתוך קובץ הגדרות תצורה המציעה את אותן היכולות לעומת הגרסה המתארחת. אנו ממליצים שתיצור ותסגנן את ה- web map שלך באמצעות הגרסה המתארחת ושתשתמש בה שוב עם ההורדה.",
				...
				tab4: {
					title: "טיפים",
					div1: "תמונות",
					div2: "אנו ממליצים על אוריינטציה רוחבית של התמונות במקום לאורך. ניתן להשתמש בתמונות עם אוריינטציה לאורך אך במסכים קטנים יותר דוגמת אייפד, רבות מהתמונות עשויות להיות מטושטשות על ידי כותרת המשנה מפני שהטקסט עשוי לקחת יותר שטח כאשר הוא מוצג באזור גבוה לעומת אזור רחב. למרות שניתן להשתמש בתמונות עם גדלים ואוריינטציות שונים בסיור ממופה, אנו ממליצים להשתמש באותו גודל וצורה בדיוק עבור כל התמונות. בדרך זו, תשומת ליבו של המשתמש לא תוסט כתוצאה מגדלים שונים של תמונה כאשר הוא עוקב אחר הסיור.",
					div3: "קביעת טקסט כותרת המשנה באמצעות תגיות HTML",
					div4: "טקסט כותרת המשנה יכול לכלול תגיות HTML בכדי להגדיר עיצוב וקישורים, ראה <a href='http://blogs.esri.com/esri/arcgis/2013/03/29/add-links-map-tour/' target='_blank'>פוסט של הבליג הזה</a>.",
					div5: "שכבות תומכות",
					div6: "באפשרותך להוסיף שכבות תומכות נוספות למפה. שכבות אלו יופיעו בסיור הממופה שלך ויסייעו באוריינטציה, רקע ועוד תכונות גיאוגרפיות שברצונך שהמפה תציג בנוסף לנקודות של הסיור הממופה, דוגמת שטח לימוד, נתיב נסיעה או הליכה המקושר לנקודות הסיור שלך וכדומה. התבנית מציגה את השכבות התומכות הללו באמצעות סימבולוגיה שאתר מגדיר ב- web map, אך החלונית הקופצת לא תהיה זמינה.",
					...
					div9: "בכדי ללמוד עוד, היוועץ <a href='https://github.com/Esri/map-tour-storytelling-template-js/raw/master/Readme.pdf' target='_blank'>במדריך המפורט הזה</a>."
				},
				tab5: {
					title: "פירסום",
					div1: "כאשר אתה מסיים, אל תשכח לשתף את הסיור הממופה עם הקהל שלך באמצעות עמוד פריט האפליקציה ב- ArcGIS Online. במהלך התהליך הזה, ArcGIS Online ישאל אותך במידת הצורך האם לעדכן את המקורות המקושרים (web map, שירות ישויות) שאין להם את אותן הרשאות שיתוף. באם אחד מהמקורות שלך לא מוגדר כמשותף עם הקהל שלך, המשתמשים יופנו מחדש לעמוד ההתחברות של ArcGIS Online.",
					div2: "אם אתה משתמש בשירות ישויות מתארח שנוצר באמצעות בונה הסיור הממופה, האפליקציה מנהלת את שירות האבטחה עבורך ואתה תישאר היחידי עם הרשאות עריכה אפילו אם תשתף את השירות הזה לציבור.",
