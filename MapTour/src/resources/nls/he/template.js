	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "אשף הבנייה של הסיור במפה אינו נתמך בגודל תצוגה זה.",
			...
			initPopupHome: {
				...
				hostedFsNA2: "זמין רק עבור חבר ב- ArcGIS Online עבור ארגונים, <a href=\'%LINK%\'>הירשם לקבלת גירסת ניסיון חינמית</a>",
