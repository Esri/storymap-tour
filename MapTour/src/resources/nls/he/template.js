...
({
		viewer: {
			...
			headerJS:{
				...
				templateSubtitle: "קבע כיתובית לתבנית"
			},
			crossFaderJS:{
			...
			viewFacebook: {
				title: "ייבוא מפיסבוק",
				header: "בצע אימות מול חשבון משתמש שלך בפייסבוק או בעמוד ציבורי. ניתן להשתמש באלבומים פרטיים בכדי ליצור סיור ממופה ציבורי שלא ידרוש אימות עם חשבון משתמש של פייסבוק, וזה יאפשר להשאיר הערות ולייקים כפרטיים.",
			...
			helpPopup: {
				...
				tab3: {
					...
					div4: "ניתן להגדיר את הגרסה הזמינה להורדה באמצעות web map או  מזהה אפליקצית מיפוי אינטרנטי. תרחישי השימוש העיקריים הם:",
					...
					div42: "אנו ממליצים על גודל תמונה של 1000 פיקסלים רוחב x‏ 750 פיקסלים גובה לתמונה המרכזית ו- 140x‏93 לתמונות הממוזערות.",
				...
				tab4: {
					...
					div12: "על מנת למקסם את נוחות שימוש, הימנע משימוש ברוחב צר של iFrame שיכול לגורם לסיור הממופה לעבור לפריסת מסך קטן, מבוסס מגע. כאשר אתה מטביע סיור ממופה, אנחנו תמיד ממליצים להוסיף קישור ליד הסיור המוטבע כך שמשתמשים יוכלו לפתוח את הסיור במסך מלא." 
				},
				tab5: {
					title: "פירסום",
