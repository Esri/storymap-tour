	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Selle kuvasuuruse korral kaardituuri koosturit ei toetata.",
			...
			initPopupHome: {
				...
				hostedFsNA2: "Saadaval ainult ArcGIS Online for Organizationsi liikmetele, <a href=\'%LINK%\'>Tasuta prooviversiooni hankimiseks logige sisse</a>",
