...
({
		viewer: {
			...
			builderHTML: {
				...
				dataPicError6: "See valik tähendab, et kõiki aadresse käsitletakse piltidena, kuid teil ei ole võimalik lisada videod interaktiivse looja kaudu. See toiming on tagasi võetav kui otsustate lisada videosid tulevikus.",
				dataPicError7: "Teie kaardituur on piiratud ainult piltidele, videosid ei saa lisada. Kui eemaldate selle piirangu, siis kontrollige, et Teie pildid ikka laevad korrektselt enne kaardituuri salvestamist. Teil on vajadusel võimalik taastada seda piirangut hiljem.",
				...
				dataExplain: "Objektiteenus lisatakse Teie veebikaardile. Seda ei jagata kõigiga ning ainult Teill on õigus andmeid lisada, muuta ja kustutada. <br /><br />Pange tähele, et kui te jagate rakendust läbi sisu lehe, siis süsteem küsib Teilt samuti objektiteenuse jagamise kohta. See on kohustuslik samm. Teil säilivad ainuisikuliselt muutmisõigused.",
			...
			helpPopup: {
				...
				tab1: {
					...
					div42: "Teiste tuuride kasutajanäidete nägemiseks <a href='http://links.esri.com/storymaps/map_tour_gallery' target='_blank'>külastage galeriid</a> <a href='http://storymaps.esri.com/' target='_blank'>Kaardilugude veebilehel</a>. Samuti jälgige meid Twitter kanalis <a href='https://twitter.com/EsriStoryMaps' target='_blank'>@EsriStoryMaps</a>.",
				...
				tab5: {
					...
					div4: "Kasulik on vaadata, kuidas kaardi tuur paistab iPad horisontaalpaigutuses, et olla kindel selle sobilikuses sellele populaarsele seadmele. Selle kaudu saate parema ülevaate, millal pealkirjad katavad liiga suure osa piltidest. Samuti annab see infot, kas alapealkiri mahub ja ei ole liiga pikk, et ta lõigataks.",
