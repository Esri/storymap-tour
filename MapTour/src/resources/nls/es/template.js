  ...
  "viewer": {
    ...
    "helpPopup": {
      ...
      "tab2": {
        ...
        "div11": "Si decide alojar sus imágenes en su propio servidor web (en lugar de acceder a las imágenes en Flickr, o cargarlas directamente en su recorrido), deberá crear manualmente vistas en miniatura para sus imágenes. El uso de imágenes de máxima resolución para la vista en miniatura supondrá una pérdida de rendimiento. Consulte estas <a href='https://links.esri.com/storymaps/faq_maptour_image_size' target='_blank'>Preguntas frecuentes</a> para obtener sugerencias sobre el tamaño de sus imágenes si va a acceder a ellas en la web directamente a través de URL.",
        "div12": "Usar datos de lugares existentes",
        "div13": "Si ya dispone de datos de lugares, por ejemplo, una lista de lugares en una hoja de cálculo o una capa de puntos SIG, puede usar dichos datos en formato CSV para crear un Map Tour. Es necesario que se acceda a sus imágenes directamente desde una URL y que estén almacenadas como valores en el archivo CSV. Puede descargar la plantilla CSV desde el cuadro de diálogo Opciones avanzadas cuando inicie el Builder de Map Tour por primera vez. Puede cargar el archivo CSV en ese cuadro de diálogo.",
        ...
        "div174": "Consulte estas <a href='https://links.esri.com/storymaps/faq_map_tour_gis_data' target='_blank'>Preguntas frecuentes</a> para más información.",
