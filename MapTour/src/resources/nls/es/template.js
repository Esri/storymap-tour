	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "El builder de Map Tour no es compatible con este tamaño de pantalla.",
			...
			builderHTML: {
				...
				dataExplainPortal: "Esta entidad requiere Portal for ArcGIS 10.4. Si no has conseguido crear la capa de entidades, contacta con tu administrador de ArcGIS.",
			...
			initPopupHome: {
				...
				hostedFsNA2: "Solo disponible para miembros de organizaciones de ArcGIS Online, <a href=\'%LINK%\'>Regístrate para una prueba gratuita</a>",
