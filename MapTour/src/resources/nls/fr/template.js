	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Le générateur Map Tour n\'est pas pris en charge avec cette taille d\'affichage.",
			...
			builderHTML: {
				...
				dataExplain: "Une nouvelle couche d\'entités va être créée pour vos images et les points de la visite. La couche Map Tour n\'est partagée avec personne sauf si vous partagez votre application Map Tour.",
			...
			initPopupHome: {
				...
				hostedFsNA2: "Disponible uniquement pour les membres d\'ArcGIS Online for Organizations. <a href=\'%LINK%\'>Créez un compte d\'évaluation gratuit</a>",
