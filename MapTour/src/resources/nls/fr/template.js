  ...
  "viewer": {
    ...
    "helpPopup": {
      ...
      "tab2": {
        ...
        "div11": "Si vous décidez d’héberger vos images sur votre serveur web (au lieu d’accéder aux images depuis Flickr ou de les télécharger directement dans votre visite), vous devez créer manuellement les miniatures correspondantes. L’utilisation d’images à résolution maximale comme miniatures donnera des performances médiocres. Consultez cette <a href='https://links.esri.com/storymaps/faq_maptour_image_size' target='_blank'>FAQ</a> pour avoir des astuces sur le dimensionnement de vos images si vous y avez accès directement sur le web via des URL.",
        "div12": "Utilisation de données de lieux existantes",
        "div13": "Si vous possédez des données de lieux, telles qu’une liste de lieux dans une feuille de calcul ou une couche de points SIG, vous pouvez utiliser ces données au format CSV pour créer un Map Tour. Pour ce faire, vos images doivent être accessibles directement via des URL stockées en tant que valeurs dans le fichier CSV. Vous pouvez télécharger le modèle CSV à partir de la boîte de dialogue Options avancées lorsque vous lancez le générateur Map Tour pour la première fois. Vous pouvez charger votre fichier CSV dans cette boîte de dialogue.",
        ...
        "div174": "Consultez ce <a href='https://links.esri.com/storymaps/faq_map_tour_gis_data' target='_blank'>FAQ</a> pour plus d’informations.",
