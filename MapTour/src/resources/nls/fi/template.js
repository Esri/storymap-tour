	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Nykyinen näyttökoko ei tue karttakierroksen luontitoimintoa.",
			...
			initPopupHome: {
				...
				hostedFsNA2: "Käytettävissä vain ArcGIS Online for Organizations -jäsenille, <a href=\'%LINK%\'>Rekisteröidy ilmaisen kokeiluversion käyttäjäksi</a>",
