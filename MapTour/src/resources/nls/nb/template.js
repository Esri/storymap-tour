	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Byggeverktøyet for kartomvisning støttes ikke med denne skjermstørrelsen.",
			...
			builderHTML: {
				...
				dataExplain: "Et nytt geoobjektslag opprettes for bildene og omvisningspunktene dine. Omvisningslaget blir ikke delt med noen med mindre du deler kartomvisningen.",
			...
			initPopupHome: {
				...
				hostedFsNA2: "Bare tilgjengelig for ArcGIS Online for Organizations-medlemer, <a href=\'%LINK%\'>registrer deg for en gratis prøveversjon</a>",
			...
			share: {
				...
				shareA1bis: "Hvis du også vil oppheve delingen av featuretjenesten, kan du bruke <a href='%LINK1%' target='_blank'>siden for featuretjenesteelementer</a>.",
