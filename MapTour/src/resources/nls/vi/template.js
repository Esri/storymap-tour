	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Bộ thiết lập Map Tour không được hỗ trợ theo kích cỡ hiển thị này.",
			...
			initPopupHome: {
				...
				hostedFsNA2: "Chỉ khả dụng đối với thành viên ArcGIS Online for Organizations, <a href=\'%LINK%\'>Hãy đăng ký để dùng thử miễn phí</a>",
