		...
		viewer: {
			...
			helpPopup: {
				...
				tab1: {
					...
					div42: "Aby zobaczyć przykładowe mapy wycieczek stworzone przez innych użytkowników, <a href='http://links.esri.com/storymaps/map_tour_gallery' target='_blank'>przejdź do galerii</a> znajdującej się na <a href='http://storymaps.arcgis.com/' target='_blank'>stronie map z historią</a>. Możesz także śledzić nas na Twitterze: <a href='https://twitter.com/EsriStoryMaps' target='_blank'>@EsriStoryMaps</a>.",
					div5: "Czekamy na wiadomości od Ciebie! Niezależnie od tego, czy masz pytanie, chcesz poprosić o nowy obiekt lub poinformować nas o znalezionym błędzie, odwiedź <a href='http://links.esri.com/storymaps/forum' target='_blank'>Forum użytkowników map opowiadań</a>."
				},
				tab2: {
					title: "Dane",
					...
					div3: "<ul><li>Możesz użyć <b>zdjęć już zamieszczonych w sieci</b>, takich jak obrazy przechowywane w witrynach przeznaczonych do udostępniania zdjęć (np. Flickr) lub obrazy przechowywane w Twojej własnej witrynie. Na mapie wycieczki zostaną utworzone odnośniki do tych obrazów, korzystające z ich adresów URL.</li><li>Możesz także <b>wczytać zdjęcia ze swojego komputera</b> bezpośrednio do mapy wycieczki. Ta opcja wymaga posiadania konta dla instytucji (ArcGIS for Organizations) oraz uprawnień publikującego lub administratora (to dlatego, że korzystanie z niej powoduje automatyczne utworzenie hostowanej usługi obiektowej, w której zdjęcia są przechowywane w postaci załączników).</li></ul>",
					div4: "Najczęstsze przypadki zastosowania to:",
					div4b: "<b>Twoje zdjęcia nie są jeszcze hostowane</b>, ale masz konto dla instytucji. Najlepszym wyborem będzie skorzystanie z hostowanej usługi obiektowej. Podobnie jak serwisy udostępniające zdjęcia, zapewnimy optymalizację Twoich obrazów w celu uzyskania zdjęć niewymagających długiego wczytywania, a Ty będziesz mieć dostęp do wszystkich funkcji administracyjnych i zarządzania danymi oferowanych przez platformę ArcGIS.",
				...
				tab3: {
					...
					div41: "Mapa wycieczki tworzona się przy użyciu interaktywnego kreatora w hostowanym środowisku, a szablon konfigurowany jest przy użyciu identyfikatora aplikacji map internetowych. Zostaną zastosowane ustawienia zdefiniowane przy użyciu interaktywnego kreatora.",
					div42: "Mapa wycieczki tworzona jest poza interaktywnym kreatorem, a szablon konfigurowany jest przy użyciu identyfikatora mapy internetowej. Aby uzyskać informacje na temat konfigurowania szablonu, należy przeczytać dokumentację.",
				...
				tab5: {
					title: "Publikacja",
					div1: "Po zakończeniu wszystkich czynności nie zapomnij udostępnić mapy wycieczki odbiorcom za pomocą przycisku UDOSTĘPNIJ lub strony elementu aplikacji w serwisie ArcGIS Online.",
			...
			share: {
				...
				firstSaveHeader: "Twoja wycieczka została zapisana w serwisie ArcGIS Online. Zapoznaj się z poniższymi odpowiedziami na często zadawane pytania.",
				...
				firstSaveA1bis: "Wycieczkę będzie również znajdować się w Twoim <a href='%LINK2%' target='_blank'> folderze zasobów w serwisie ArcGIS Online</a>.",
				...
				shareA3: "Konfiguracja wycieczki jest przechowywana w <a href='%LINK1%' target='_blank'>tym elemencie mapy internetowej</a> i <a href='%LINK2%' target='_blank'>tym elemencie aplikacji internetowej</a>. Obrazy z serwisów Flickr, Picasa, Facebook lub filmy wideo z serwisu YouTube są nadal przechowywane w tych serwisach i nie są duplikowane w serwisie ArcGIS Online.",
