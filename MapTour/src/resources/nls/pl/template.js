	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Kreator Mapy wycieczki nie jest obsługiwany przy tej wielkości ekranu.",
			...
			builderHTML: {
				...
				dataExplain: "Zostanie utworzona nowa warstwa obiektu dla obrazów i punktów wycieczki. Warstwa wycieczki nie będzie udostępniana, jeśli mapa wycieczki nie zostanie udostępniona.",
			...
			initPopupHome: {
				...
				hostedFsNA2: "Dostępne tylko dla usługi ArcGIS Online i dla członków instytucji. <a href=\'%LINK%\'>Zarejestruj się, aby uzyskać dostęp do bezpłatnej wersji próbnej</a>",
