		...
		viewer: {
			...
			helpPopup: {
				...
				tab2: {
					...
					div3: "<ul><li>Możesz użyć <b>zdjęć już zamieszczonych w sieci</b>, takich jak obrazy przechowywane w witrynach przeznaczonych do udostępniania zdjęć (np. Flickr) lub obrazy przechowywane w Twojej własnej witrynie. Na mapie wycieczki zostaną utworzone odnośniki do tych obrazów, korzystające z ich adresów URL.</li><li>Możesz także <b>wczytać zdjęcia ze swojego komputera</b> bezpośrednio do mapy wycieczki. Ta opcja wymaga posiadania subskrypcji ArcGIS Online oraz uprawnień publikującego lub administratora (to dlatego, że korzystanie z niej powoduje automatyczne utworzenie hostowanej usługi obiektowej, w której zdjęcia są przechowywane w postaci załączników).</li></ul>",
