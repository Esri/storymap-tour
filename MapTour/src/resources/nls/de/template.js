		...
		viewer: {
			...
			helpPopup: {
				...
				tab5: {
					...
					div1: "Vergessen Sie nach der Fertigstellung nicht, Ihre Map Tour über die Schaltfläche FREIGEBEN oder die Seite der Anwendungselemente in ArcGIS Online für Ihre Zielgruppe freizugeben.",
					...
					div5b: "Damit Ihre Map Tour leichter in ArcGIS Online gefunden werden kann, wird empfohlen, das Tag \"Story Map\" auf der Seite der Anwendungselemente der Tour (nicht auf der Elementseite der Karte) gemeinsam mit Tags, beispielsweise der Name des Bundesstaates oder des Kantons, in dem sich die Tour befindet, der Namen des Landes, falls sie sich außerhalb der USA befindet, und thematische Tags wie \"öffentliche Kunst\", \"Reiseführer\" oder \"historische Orte\" hinzuzufügen. Diese Tags erleichtern Esri die Suche nach coolen neuen Touren, um sie in eigenen Galerien darzustellen und in Social Media zu bewerben. Es wird außerdem empfohlen, eine ansprechende Miniaturansicht, wie beispielsweise einen kleinen Screenshot der Tour oder eines der Tour-Bilder, auf die Seite der Anwendungselemente hochzuladen. Dieses Bild wird automatisch verwendet, wenn Ihre Map Tour einer ArcGIS Online-Galerie hinzugefügt wird."
				}
			},
			share: {
