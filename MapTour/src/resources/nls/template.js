	...
	root: ({
		viewer: {
			...
			builderHTML: {
				...
				dataExplainPortal: "This feature requires Portal for ArcGIS 10.4. If you are not successful in creating the Feature Layer please contact your ArcGIS administrator.",
				...
				coverPreview: "To see the cover, save your story then preview it using the Share button."
			},
			addPopupJS: {
			...
			helpPopup: {
				...
				tab4: {
					...
					div4b: "Take time to write a compelling subtitle for your tour. The subtitle is a good way to draw people into your tour and tell them what they will discover in it. It is also a good place to tell your audience the state or country that the tour is located in. For example don't assume that people know where the city or town in your tour is located. Don't make the subtitle too long though. If you can't think of a good subtitle, leave it blank. In the Side-panel layout the subtitle that appears on the cover page is the caption for the first point in your tour (if you are using the option in the Organize dialog to use the first point's content as a cover page).",
					div5: "Supporting Layers",
					div6: "You can add additional supporting layers to provide context to the Map Tour. These layers may contain other geographic features you want the map to show in addition to the Map Tour points, such as a study area, a walking or driving route linking your tour points, etc. The Map Tour template displays these additional supporting layers using the symbology you specify in the web map, but the popups aren't available.  To add supporting layers to your tour, save your work and close the Map Tour Builder. Then open the web map used in your tour. You can find this in ArcGIS My Content or via the My Stories section of the Story Maps website.",
