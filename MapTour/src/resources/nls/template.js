	...
	root: ({
		viewer: {
			...
			initPopupHome: {
				...
				hostedFSTooltip: "Upload your images and store them with the Map Tour layer (doesn't support video).",
				...
				hostedFsNA2: "Only available for ArcGIS Online for Organizations member, <a href='%LINK%'>Sign up for a free trial</a>",
