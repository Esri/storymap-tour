	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Il generatore di Tour mappa non è supportato per questa dimensioni schermo.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "Caricare le immagini e memorizzarle con il layer Tour mappa (non supporta video).",
				...
				hostedFsNA2: "Disponibile solo per membri di ArcGIS Online for Organizations, <a href=\'%LINK%\'>Richiedi versione di prova gratuita</a>",
