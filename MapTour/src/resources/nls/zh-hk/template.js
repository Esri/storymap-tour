  ...
  "viewer": {
    ...
    "helpPopup": {
      ...
      "tab2": {
        ...
        "div3": "<ul><li>您可以使用<b>已經在線上的照片</b>，例如 Flickr 中的圖片，或您自己的 Web 伺服器所儲存的圖片。 透過這些圖片的 URL，在您的 Map Tour 中參考它們。</li><li>還可以<b>透過電腦將照片</b>直接上傳到您的 Map Tour。 該上傳選項需要您具有 ArcGIS 訂閱並擁有發佈者或管理員權限，因為系統將自動為您建立託管圖徵服務，您可將照片做為附件儲存在其中。</li></ul>",
        "div4": "主要用例包括:",
        ...
        "div11": "如果選擇在自己的 Web 伺服器上託管圖片 (而非在 Flickr 中存取圖片，或將它們直接上傳到您的導覽)，則必須手動建立圖片的縮圖。 使用完整解析度的圖片建立縮圖將導致效能不佳。 若要透過 URL 直接在 Web 上存取圖片，請參閱此<a href='https://links.esri.com/storymaps/faq_maptour_image_size' target='_blank'>常見問題集</a>以取得調整圖片大小的提示。",
        "div12": "使用現有的地點資料",
        "div13": "如果您擁有現成的地點資料 (例如試算表或 GIS 點圖層中的地點清單)，您可以利用 CSV 格式使用該資料來建立 Map Tour。 若要這麼做，必須可透過 CSV 檔案中儲存為值的 URL 來直接存取您的圖片。 第一次啟動 Map Tour 建立器時，您可以從「進階選項」對話方塊下載 CSV 樣板。 可將您的 CSV 檔案上傳到該對話方塊。",
        ...
        "div174": "有關詳細資訊，請參閱<a href='https://links.esri.com/storymaps/faq_map_tour_gis_data' target='_blank'>常見問題集</a>。",
        ...
        "div20": "支援的圖片格式和影片",
        "div21": "若在 Flickr 中存取圖片，Map Tour 將自動存取那些 .jpg 圖片檔。 若將圖片上傳到 Map Tour 建立器，圖片必須具有 .jpg 或 .jpeg 格式。 若透過圖片的 URL，直接在 Web 上參考該圖片，則支援的圖片格式將是 .jpg、.jpeg、.png、.gif 和 .bmp。 直接支援 YouTube 影片。",
