define({
  "viewer": {
    ...
    "errors": {
      ...
      "featureServiceLoad": "Chyba při načítání Feature služby",
    ...
    "builderHTML": {
      ...
      "buttonHelp": "Nápověda",
      "buttonOrganize": "Uspořádat",
      "buttonOrganizeAndCover": "Uspořádat body prohlídky a přidat úvodní stránku",
      "buttonAdd": "Přidat",
      "buttonImport": "Import",
      "buttonImportDisabled": "Při nahrávání snímku není k dispozici import. Pro nahrání snímku klikněte na tlačítko ‚Přidat‘.",
      "dataEditionDisabled": "Úprava dat je u tohoto zdroje dat ve formátu CSV zakázána.",
      "dataSourceWarning": "Vrstva dat prohlídky mapy se změnila. Nejsou-li ID prvků stejná, musíte resetovat pořadí a skryté body pomocí volby <b>Uspořádat</b>. Pokud se liší názvy polí, musíte resetovat nastavení polí v <b>záložce dat v Nastavení</b>.",
      ...
      "modalCancel": "Storno",
      "modalApply": "Použít",
      "organizeHeader": "Uspořádat prohlídku",
      ...
      "settingsLayoutSelect": "Výběr",
      "settingsLayoutNote": "Při používání videí na bodech bude pod videem vždy popisek, i když tato možnost není zaškrtnuta.",
      ...
      "settingsExtentExplain": "Nastavte výchozí rozsah prohlídky mapy na níže uvedené interaktivní mapě.",
      "settingsExtentExplainBottom": "Podle definovaného rozsahu se upraví výchozí rozsah webové mapy. Pokud rozsah neobsahuje první bod prohlídky, nepoužije se. Prohlídka se v takovém případě otevře vycentrovaná na první bod.",
      ...
      "dataExplainPortal": "Pokud se vrstva prvků úspěšně nevytvoří, obraťte se prosím na svého správce ArcGIS.",
      "dataNameLbl": "Jméno vrstvy",
      "dataFolderListLbl": "Složka",
      "dataFolderListFetching": "Načítání složek…",
      "dataRootFolder": "Kořenový adresář",
      "dataNameError": "Zadejte název Feature služby",
      "dataFolderError": "Vyberte platnou složku",
      "dataSrcContainsInvalidChar": "Jméno feature služby obsahuje jeden nebo několik neplatných znaků (-, <, >, #, %, :, \", ?, &, +, /, nebo ).",
      ...
      "coverPreview": "Pokud si chcete prohlédnout úvodní stránku, uložte svůj příběh a otevřete náhled pomocí tlačítka Zobrazit příběh.",
    ...
    "addPopupJS": {
      ...
      "errorInvalidPicUrl": "Vložte platnou adresu URL obrázku. Začíná na https. Končí na jpg, png, gif či bmp, případně připojte na konec adresy URL řetězec ‚#isImage‘ pro přepsání pravidla.",
      "errorInvalidThumbUrl": "Zadejte platnou miniaturu (začíná https:// a končí příponou jpg, png, gif nebo bmp).",
      "errorInvalidVideoUrl": "Zadejte platnou adresu URL videa (začíná https://).",
    ...
    "builderJS": {
      ...
      "closeWithPendingChange": "Určitě chcete akci potvrdit? Přijdete o své změny.",
      "gotIt": "OK",
    ...
    "headerJS": {
      "editMe": "Edituj mě!",
      "templateTitle": "Nastavit nadpis",
      "templateSubtitle": "Nastavit podnadpis",
      "edit": "Upravit"
    },
    "crossFaderJS": {
    ...
    "viewFlickr": {
      ...
      "header": "Zadejte své uživatelské jméno ve službě Flickr a vyberte album nebo značku k importu.",
      "userInputLbl": "Zadat uživatelské jméno",
      "signInMsg2": "Uživatel nenalezen",
      "selectSet": "Vybrat album",
      "selectTag": "nebo Vybrat značku",
      "footerImportTag": "Importovat vybranou značku",
      "footerImportSet": "Importovat vybraného alba"
    },
    "viewFacebook": {
    ...
    "viewPicasa": {
      "title": "Import z Google+",
      "header": "Zadejte svou e-mailovou adresu nebo ID.",
      "userInputLbl": "E-mail nebo identifikátor Picasa/Google+",
      "signInMsg2": "Účet nenalezen",
      "signInMsg3": "Žádné veřejné album",
      "howToFind": "<a href=‘https://links.esri.com/storymaps/google-photos-help‘ target=‘_blank‘>Více informací</a>",
    ...
    "viewGeoTag": {
      ...
      "header": "Budou importovány umístěné nalezené položky. Klikněte na jakékoli nelokalizované položky, které chcete importovat, abyste je našli.",
      "headerMore": "Nápověda",
      "headerExplain": "Pokud kliknete na tlačítko <b>Import</b> importují se pouze snímky či videa nacházející se na kartě <b>Lokalizované</b>.<br><br>Informace o geolokaci uložené spolu se snímky nebo videi se importují automaticky, pokud jsou přístupné. Veškeré položky bez geolokace jsou uvedeny na kartě <b>K lokalizaci</b>. Pro lokalizaci položky uvedené na této kartě na položku klikněte a následně klikněte na požadovanou lokaci na mapě.<br><br>Pokud si přejete odstranit položku z karty <b>Umístěno</b>, aby se neimportovala, klikněte na tlačítko Neimportovat, který se objeví, jakmile přesunete kurzor na danou položku.<br><br>Tip: Pokud se informace o geolokaci vašich médií neimportují, zkontrolujte nastavení soukromí vašeho účtu. Např. u vašeho účtu služby Flickr se ujistěte, že nejsou skryty údaje EXIF. Pokud je u služby Flickr vypnutá volba importu dat EXIF pro nově nahraná data (výchozí nastavení), geolokace se u vašich snímků ve Flickru neuloží, pokud je nenahrajete ještě jednou nebo nespecifikujete jejich umístění na Flickru.",
      "leftPanelTab1": "Umístit",
      "leftPanelTab2": "Umístěno",
      "clickOrTap": "Kliknutím a mapu provedete umístění",
    ...
    "initPopupHome": {
      ...
      "hostedFsNA": "Musíte mít roli Vydavatele nebo jinou roli s oprávněním zveřejňovat hostované vrstvy prvků. Obraťte se na svého správce ArcGIS.",
    ...
    "helpPopup": {
      ...
      "tab1": {
        ...
        "mtFAQ": "Viz <a href=‘https://storymaps.arcgis.com/en/faq/#category4‘ target=‘_blank‘>Často kladení otázky týkající se prohlídky mapy.</a>",
      ...
      "tab2": {
        ...
        "div6": "<b>Chcete znovu využít stávající Feature službu</b>, ve které jsou obrázky uloženy jako přílohy nebo která odkazuje na externě uložené obrázky. Podrobný návod najdete v příslušné části níže.",
        ...
        "div11": "Pokud se rozhodnete své snímky hostovat na vlastním webovém serveru (místo použití služby Flickr nebo přímého nahrání do vaší prohlídky), budete muset ručně vytvořit miniatury. Použití snímků v plném rozlišení pro náhledy sníží výkon systému. V <a href=‘https://links.esri.com/storymaps/faq_maptour_image_size‘ target=‘_blank>často kladených dotazech</a> naleznete tipy pro úpravu velikosti, pokud k nim přistupujete přímo pomocí adres URL na web.",
        "div12": "Použití stávajících dat umístění",
        "div13": "Pokud máte stávající data umístění, jako je například tabulkový seznam míst nebo bodová vrstva GIS, můžete tato data použít ve formátu CSV k vytvoření prohlídky mapy. To vyžaduje, aby bylo možné k vašim obrázkům získat přístup přímo přes adresy URL, které jsou uložené jako hodnoty v souboru CSV. Šablonu CSV si můžete stáhnout z dialogového okna Rozšířené možnosti při prvním spuštění nástroje pro tvorbu prohlídky mapy. Váš soubor CSV lze nahrát do tohoto dialogového okna.",
        ...
        "div154": "Miniatura",
        "div155": "Barva ",
        "div16": "Pokud aplikace při použití Feature služby nenajde odpovídající pole, nebude prohlížeč fungovat, dokud pole pro použití  nenakonfigurujete nástrojem pro tvorbu. Vrstvy CSV a shapefile přidané do webové mapy musí obsahovat všechna požadovaná pole, jinak nebude nástroj pro tvorbu fungovat.",
        "div162": "Při používání feature služby, která obrázky ukládá jako přílohy, <b>budou použity pouze prvky se dvěma přílohami</b>. První příloha určuje hlavní obrázek, druhá příloha určuje miniaturu.",
        "div17": "Pole obrázku a miniatury jsou povinná pro feature službu bez příloh. Pro feature službu s přílohami jsou volitelné (ale důrazně je doporučujeme). Pokud máte ve službě povolené přílohy, nástroj pro tvorbu vám umožní nahrávat obrázky jako přílohy. V opačném případě budete moci pouze editovat adresu URL obrázku a miniatury.",
        "div172": "Pokud jsou pole obrázku a miniatury přítomny, budou vždy použity a přílohy feature služby nebudou dotazovány.",
        "div173": "Vzorové soubory CSV a shapefile můžete stáhnout z",
        "div174": "Více informací naleznete v těchto <a href='https://links.esri.com/storymaps/faq_map_tour_gis_data' target='_blank'>často kladených dotazech</a>.",
        "div18": "Vytváření hostovaných Feature služeb ze souboru CSV nebo shapefile",
        "div19": "Při vytváření hostovaných Feature služeb ze souboru CSV nebo shapefile nejsou přílohy ve výchozím nastavení povoleny. Chcete-li je povolit, otevřete stránku podrobností Feature služby a klikněte na malou šipku v sekci vrstev. Daná možnost se zobrazí. Prohlídka map bude nadále používat obrázky a miniatury, na které odkazujete prostřednictvím atributů. Pokud chcete obrázky nahrát jako přílohy Feature služby, bude to možno provést volitelně dvěma tlačítky na panelu obrázků (Změnit obrázek a Změnit miniaturu).",
        "div20": "Podporované formáty obrázků a videí",
        "div21": "Pokud jsou snímky ve službě Flickr, prohlídka map k nim automaticky přistupuje jako k souborům .jpg. Pokud snímky nahrajete do nástroje pro tvorbu prohlídky mapy, snímky musejí být ve formátu .jpg či .jpeg. Pokud odkazujete na snímky přímo na webu pomocí adres URL, podporovanými formáty jsou .jpg, .jpeg, .png, .gif a .bmp. Videa YouTube jsou podporovány přímo.",
        ...
        "div23": "Interaktivní nástroj pro tvorbu neobsahuje dialogové rozhraní pro přidání videa při používání feature službu s přílohami, ale je možné tak učinit úpravou vašich dat mimo nástroj pro tvorbu. Pokud ve webovém prohlížeči na stránkách arcgis.com upravíte pole obrázků tak, aby odkazovala na externí video, a přidáte na konec adresy URL speciální parametr (#isVideo), budou vaše média považována za video.",
        "div24": "Mějte na paměti, že je stále nutné mít dvě platné přílohy s obrázky, jinak bod nebude použit. U příloh Feature služby bez polí pro obrázek a miniaturu nelze používat videa."
      },
      "tab3": {
        "title": "Přizpůsobení",
      ...
      "tab4": {
        ...
        "div4aa": "<b>Vytvořte si úvodní stránku pro prohlídku postranního panelu</b><br>Rozvržení postranního panelu podporuje volitelnou úvodní stránku, takže můžete své publikum upoutat skvěle vypadajícím celostránkovým snímkem. Pro konfiguraci úvodní stránky pro prohlídku postranního panelu, nejprve do své prohlídky přidejte některé nebo všechny body. Následně klikněte na tlačítko Uspořádat a v dialogu, který se objeví, se ujistěte, že bod prohlídky, který si přejete použít pro definici úvodní stránky, je prvním bodem prohlídky. Následně v tomto dialogu klikněte na ‚Použít první bod jako úvodní stránku‘.Název vašeho prvního bodu prohlídky se použije jako titulek na úvodní stránce, popisek daného bodu se použije jako podtitulek a snímek bodu se stane obrázkem úvodní stránky. Videa na úvodní stránce nejsou podporována. Více informací naleznete v těchto <a href=‘https://links.esri.com/storymaps/faq_map_tour_cover_page_sp‘ target=‘_blank‘>často kladených dotazech</a>.</a>",
        "div4a": "Napište pro svou prohlídku vhodný podnadpis",
        "div4b": "Dejte si práci s vymyšlením přitažlivého podtitulku pro svoji prohlídku. Podtitulek je dobrým způsobem, jak upoutat pozornost lidí k vaší prohlídce a říct jim, co od ní mohou čekat. V podtitulku můžete také sdělit svému publiku, v které zemi se prohlídka nachází. Například nepředpokládejte, že lidé budou vědět, kde leží město, ve kterém se nachází vaše prohlídka. Na druhou stranu by podtitulek neměl být příliš dlouhý. Pokud vás nenapadá dobrý podtitulek, nechte pole prázdné. Na rozdíl od trojpanelu a uceleného rozvržení nepodporuje rozvržení postranního panelu titulek v hlavičce. Pokud v rozvržení postranního panelu použijete úvodní stránku, popisek prvního bodu vaší prohlídky se zobrazí na úvodní stránce, a tudíž slouží jako podtitulek vaší prohlídky.",
        "div5": "Podpůrné vrstvy",
        "div6": "Do mapy můžete přidat další podpůrné vrstvy, které poskytnou související informace k prohlídce mapy. Tyto vrstvy mohou obsahovat jiné geografické prvky, které chcete zobrazovat v mapě mimo body prohlídky. Sem patří například studijní oblast, pěší nebo jízdní trasa spojující vaše body prohlídky atd. Šablona prohlídky mapy zobrazuje tyto další podpůrné vrstvy pomocí symbolů, které si zvolíte ve webové mapě. Vyskakovací okna ovšem nejsou k dispozici. Pokud chcete přidat podpůrné vrstvy do prohlídky, uložte svoji práci a zavřete nástroj pro tvorbu prohlídky mapy. Poté otevřete webovou mapu použitou ve vaší prohlídce. Tu najdete v sekci Můj obsah platformy ArcGIS nebo pomocí sekce Moje příběhy na webové stránce map s příběhem.",
      ...
      "tab5": {
        ...
        "div2b": "Tlačítko SDÍLET aktualizuje položky aplikace a webové mapy. Pokud jsou vaše data prohlídky uložena v položce Feature služby, bude také aktualizována. Pokud jste přidali další vrstvy v prohlížeči map ArcGIS.com, nebudou aktualizovány. To může mít za následek, že prohlídka nebude sdílena podle očekávání. Položky, které již mají vyžadovaná (nebo vyšší) oprávnění, nebudou aktualizovány.",
        "div2c": "Sdílení prohlídky přes ArcGIS Online",
        "div2d": "Sdílíte-li aplikaci přes ArcGIS Online, budete v případě potřeby požádáni, abyste aktualizovali související zdroje (webovou mapu, Feature službu, dekorační vrstvu), které nejsou sdíleny stejným způsobem. Pokud je prohlídka mapy veřejná a jeden z vašich zdrojů není sdílen s uživateli, uživatelé budou přesměrováni na přihlašovací stránku ArcGIS Online.",
        "div3t": "Bezpečnost Feature služby",
        "div3a": "Pokud používáte hostovanou feature službu vytvořenou nástrojem pro tvorbu prohlídek map, bude za vás aplikace spravovat zabezpečení služby. Zůstanete jediným uživatelem s oprávněním k editaci, i když budete službu sdílet veřejně.",
    ...
    "share": {
      ...
      "manageStoryA1": "Tip: Sekci %LINK1% můžete použít k vyhledání chyb ve vašem příběhu a změně způsobu sdílení jeho součástí. Získejte více informací o části Moje příběhy %LINK2%.",
