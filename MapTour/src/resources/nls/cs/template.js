  ...
  "viewer": {
    ...
    "helpPopup": {
      ...
      "tab2": {
        ...
        "div11": "Pokud se rozhodnete vaše snímky hostovat na vlastním webovém serveru (místo použití služby Flickr či Google+ nebo přímého nahrání do vaší prohlídky), budete muset ručně vytvořit náhledy snímků. Použití snímků v plném rozlišení pro náhledy sníží výkon systému. V <a href=‘https://links.esri.com/storymaps/faq_maptour_image_size‘ target=‘_blank>často kladených dotazech</a> naleznete tipy pro úpravu velikosti, pokud k nim přistupujete přímo pomocí adres URL na web.",
        ...
        "div174": "V těchto <a href=‘https://links.esri.com/storymaps/faq_map_tour_gis_data‘ target=‘_blank‘>Často kladených dotazech</a> naleznete další informace týkající se stávajících údajů GIS.",
