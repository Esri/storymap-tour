	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Nástroj pro tvorbu prohlídky mapy není v této velikosti zobrazení podporován.",
			...
			builderHTML: {
				...
				dataExplain: "Pro vaše obrázky a body prohlídky bude vytvořena nová vrstva prvků. Vrstva prohlídky nebude s nikým sdílena, dokud svou prohlídku mapy nezačnete sdílet.",
			...
			initPopupHome: {
				...
				hostedFsNA2: "K dispozici pouze pro členy ArcGIS Online for Organizations, <a href=\'%LINK%\'>Zaregistrujte si bezplatnou zkušební verzi</a>",
