	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "O builder Apresentação de Mapa não é suportado com este tamanho de ecrã.",
			...
			builderHTML: {
				...
				dataExplain: "Uma nova Camada de Elementos será criada para as suas imagens e pontos de Apresentação. A camada Apresentação não será partilhada com ninguém, a não ser que partilhe a sua Apresentação de Mapa.",
			...
			initPopupHome: {
				...
				hostedFsNA2: "Apenas disponível para membro de ArcGIS Online for Organizations, <a href=\'%LINK%\'>Registe-se para um teste gratuito</a>",
