  ...
  "viewer": {
    ...
    "helpPopup": {
      ...
      "tab2": {
        ...
        "div11": "Caso opte por armazenar as suas imagens no seu próprio servidor web (em vez de aceder a imagens no Flickr ou de carregá-las diretamente para a sua apresentação), terá de criar manualmente miniaturas para as suas imagens. Utilizar as imagens de resolução total para a imagem miniatura resultará em fraco desempenho. Consulte estas <a href='https://links.esri.com/storymaps/faq_maptour_image_size' target='_blank'>FAQ</a> para obter dicas sobre como dimensionar as suas imagens caso lhes aceda na web diretamente através de URLs.",
        "div12": "Utilizar dados de locais existentes",
        "div13": "Se tiver dados de locais existentes, tais como uma lista de locais numa folha de cálculo ou camada de pontos SIG, pode utilizá-los em formato CSV para criar uma Apresentação do Mapa. Isto requer que as suas imagens possam ser acedidas diretamente através de URLs armazenados como valores no ficheiro CSV. Pode transferir o modelo CSV da caixa de diálogo Opções avançadas quando iniciar pela primeira vez o Builder da Apresentação de Mapa. O seu ficheiro CSV pode ser carregado nessa caixa de diálogo.",
        ...
        "div174": "Consulte esta <a href='https://links.esri.com/storymaps/faq_map_tour_gis_data' target='_blank'>FAQ</a> para obter mais informações.",
        ...
        "div21": "Caso aceda a imagens no Flickr, a Apresentação do Mapa acede automaticamente a essas imagens como ficheiros .jpg. Caso carregue imagens para o Builder da Apresentação de Mapa, as imagens têm de encontrar-se em formato .jpg ou .jpeg. Caso referencie imagens diretamente na web através dos respetivos URLs, os formatos de imagem suportados são .jpg, .jpeg, .png, .gif e .bmp. Vídeos do YouTube são suportados diretamente.",
