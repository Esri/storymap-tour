  ...
  "viewer": {
    ...
    "helpPopup": {
      ...
      "tab2": {
        ...
        "div3": "<ul><li>您可以使用<b>在线照片</b>，例如 Flickr 或 Google+ 中的图像，或存储在您自己 web 服务器中的图像。 可以通过图像的 URL 在 Map Tour 中引用该图像。</li><li>您还可以<b>将计算机中的图片</b>直接上传到您的 Map Tour。 此上传选项要求您拥有 ArcGIS 订阅，并拥有发布者或管理员权限，因为系统将自动为您创建托管要素服务，您可将图片作为附件存储在其中。</li></ul>",
        "div4": "主要用例包括:",
        ...
        "div11": "如果您选择在自己的 web 服务器上托管图片(而不是访问 Flickr 或 Google+ 中的图像，或直接将图像上传到您的游览)，则必须手动创建图片的缩略图。 对缩略图使用全分辨率图片将会对性能产生不利影响。 如果将要通过 URL 直接访问 web 中的图像，请参阅此<a href='https://links.esri.com/storymaps/faq_maptour_image_size' target='_blank'>常见问题解答</a>了解有关设置图像大小的提示。",
        "div12": "使用现有 GIS 数据",
        ...
        "div174": "有关使用现有 GIS 数据的详细信息，请参阅此<a href='https://links.esri.com/storymaps/faq_map_tour_gis_data' target='_blank'>常见问题解答</a>。",
        ...
        "div20": "支持的图片格式和视频",
        "div21": "如果访问 Flickr 或 Google+ 中的图像，Map Tour 会自动将这些图像作为 .jpg 文件进行访问。 如果要将图像上传到 Map Tour 构建器，则图像必须采用 .jpg 或 .jpeg 格式。 如果直接通过 URL 引用 web 上的图像，则受支持的图片格式包括 .jpg、.jpeg、.png、.gif 和 .bmp。 支持直接使用 YouTube 视频。",
