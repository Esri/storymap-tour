	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "此显示器大小不支持 Map Tour 构建器。",
			...
			builderHTML: {
				...
				dataExplain: "将为您的图像和“浏览”点创建一个新的“要素图层”。“浏览”图层不会与其他人共享，除非您共享 Map Tour。",
			...
			initPopupHome: {
				...
				hostedFsNA2: "仅限 ArcGIS Online 的“组织”成员使用。<a href=\'%LINK%\'>注册以获取免费的试用版</a>",
