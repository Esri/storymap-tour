	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "De Map Tour-builder wordt niet ondersteund op deze schermresolutie.",
			...
			initPopupHome: {
				...
				hostedFsNA2: "Uitsluitend beschikbaar voor ArcGIS Online for Organizations-leden, <a href=\'%LINK%\'>Schrijf u nu in voor een gratis proefversie</a>",
