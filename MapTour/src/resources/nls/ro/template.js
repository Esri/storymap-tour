	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Aplicaţia de creare Tur de hartă nu este suportată la această dimensiune a ecranului.",
			...
			initPopupHome: {
				...
				hostedFsNA2: "Disponibil doar pentru ArcGIS Online pentru membrii organizaţiilor, <a href=\'%LINK%\'>Înregistraţi-vă pentru o perioadă de evaluare gratuită</a>",
