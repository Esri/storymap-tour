		...
		viewer: {
			...
			helpPopup: {
				...
				tab4: {
					...
					div4b: "Alocaţi timp pentru redactarea unui subtitlu atrăgător pentru tur. Subtitlul constituie un mijloc bun de a atrage oamenii să parcurgă turul şi de a le spune ce vor descoperi în el. De asemenea, este un loc potrivit pentru a comunica audienţei statul sau ţara în care este localizat turul. De exemplu, nu presupuneţi că audienţa ştie unde se află localitatea prezentată în tur. Subtitlul poate fi, de asemenea, formatat folosind etichete HTML, precum în cazul includerii unor linkuri. Totuşi, nu faceţi subtitlul prea mare. În ferestrele de browser mai mici sau pe iPad este posibil să nu încapă complet şi să fie ciuntit. Dacă nu găsiţi niciun subtitlu bun, lăsaţi-l necompletat.",
				...
				tab5: {
					title: "Publicarea",
					div1: "După ce terminaţi, nu uitaţi să împărtăşiţi Turul hărţii cu audienţa folosind butonul Partajare sau pagina elementului aplicaţie din ArcGIS Online.",
			...
			share: {
				...
				shareHeader2: "Turul dvs. este accesibil membrilor organizaţiei (este necesară conectarea).",
