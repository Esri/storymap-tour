...
({
		viewer: {
			...
			builderHTML: {
				...
				addSelectCaptionNoFileReader: "Selectare fotografie",
			...
			addPopupJS: {
				...
				errorInvalidPicUrl: "Introduceţi o fotografie validă (începe cu http(s)://, se termină cu jpg, png, gif sau bmp). Pentru a ocoli această regulă, puteţi termina URL-ul cu '#isPicture'.",
			...
			viewFacebook: {
				header: "Autentificaţi-vă cu un cont de utilizator Facebook sau utilizaţi o pagină publică. Se pot utiliza albume private pentru crearea unui tur al hărţii public, care nu necesită autentificarea utilizator pe Facebook, ceea ce permite rămânerea privată a comentariilor şi calificativelor Îmi place.",
			...
			viewGeoTag: {
				...
				loading: "Se încarcă",
				error: "Importul locaţiilor fotografiilor a eşuat, locaţiile au fost ignorate."
			},
			initPopup: {
			...
			initPopupHome: {
				...
				footer2: "Ajutor pentru Turul hărţii",
			...
			helpPopup: {
				...
				tab1: {
					...
					div3: "Acest Ajutor vă va ghida în paşii pentru publicarea Turului hărţii, de exemplu:",
				...
				tab2: {
					...
					div16: "Câmpurile pentru nume şi descriere sunt obligatorii. Dacă aplicaţia nu găseşte câmpuri corespunzătoare la utilizarea unui serviciu de obiecte spaţiale, aplicaţia de vizualizare nu va funcţiona până când nu configuraţi câmpurile de utilizat în instrumentul de creare. Straturile tematice CSV sau shapefile adăugate în harta web trebuie să aibă toate câmpurile necesare sau instrumentul de creare nu va funcţiona.",
				...
				tab4: {
					...
					div2a: "Dacă găzduiţi voi înşivă fotografiile, vă recomandăm o rezoluţie maximă de <b>1090x725</b> pentru fotografiile principale şi <b>140x93</b> pentru miniaturi.",
				...
				tab5: {
					title: "Publicarea",
					div1: "După ce terminaţi, nu uitaţi să împărtăşiţi Turul hărţii cu audienţa prin pagina cu detaliile aplicaţiei din ArcGIS Online. În cadrul acestui proces, dacă este necesar, ArcGIS Online vă va solicita să actualizaţi toate resursele de care depinde (harta web, serviciul de obiecte spaţiale) şi care nu sunt partajate în acelaşi fel. Dacă Turul hărţii este public şi una din resurse nu este partajată cu audienţa, utilizatorii vor fi redirecţionaţi către pagina de autentificare ArcGIS Online.",
					...
					div4: "O idee bună este să vedeţi cum arată turul hărţii dvs. pe un iPad ţinut în poziţia peisaj. Acest lucru este util pentru a vedea dacă subtitlurile acoperă prea mult din imagini."
				}
			}
        }
    })
