		...
		viewer: {
			...
			helpPopup: {
				...
				tab1: {
					...
					div42: "他のユーザが作成しているマップ ツアーの例を表示するには、<a href='http://storymaps.esri.com/' target='_blank'>ストーリー マップ Web サイト</a>の<a href='http://links.esri.com/storymaps/map_tour_gallery' target='_blank'>ギャラリーに移動します</a>。また、<a href='https://twitter.com/EsriStoryMaps' target='_blank'>@EsriStoryMaps</a> で Esri の Twitter をフォローすることもできます。",
