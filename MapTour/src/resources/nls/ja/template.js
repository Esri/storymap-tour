	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "マップ ツアー ビルダーは、このディスプレイ サイズではサポートされていません。",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "画像をアップロードして、マップ ツアー レイヤーに格納します (ビデオはサポートされていません)。",
				hostedFsNA: "公開者であるか、ホスト フィーチャ レイヤーを公開する権限を持つ別のロールである必要があります。ArcGIS 管理者に連絡してください。",
				hostedFsNA2: "組織サイトのメンバーのみが ArcGIS Online で使用できます。<a href=\'%LINK%\'>無料トライアルにサイン アップしてください。</a>",
