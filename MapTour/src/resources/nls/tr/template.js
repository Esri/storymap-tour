...
({
		viewer: {
			...
			builderHTML: {
				...
				settingsExtentDateLineError: "Yayılım 180° boylam meridyeninden geçemez",
			...
			viewYoutube: {
				...
				howToFind: "Youtube kullanıcı adı nasıl bulunur",
			...
			helpPopup: {
				...
				tab2: {
					...
					div3: "<ul><li>Flickr gibi bir fotoğraf paylaşma sitesinde depolanan görüntüler gibi <b>zaten çevrimiçinde olan fotoğrafları</b> veya kendi web sitenizde depolanan görüntüleri kullanabilirsiniz. Harita Turunda bu görüntülere URL\'leri yoluyla başvurulur.</li><li>Ayrıca, Harita Turunuza doğrudan <b>bilgisayarınızdaki fotoğrafları yükleyebilirsiniz</b>. Bu yükleme seçeneği bir ArcGIS Online aboneliğiniz olmasını ve Yayıncı veya Yönetici ayrıcalıklarına sahip olmanızı gerektirir çünkü fotoğraflarınızın ekler olarak depolandığı barındırılan bir detay servisi sizin adınıza otomatik olarak oluşturulur.</li></ul>",
					div4: "Ana kullanım örnekleri şunlardır:",
					div4b: "Henüz <b>fotoğraflarınız barındırılmıyordur</b> ve bir ArcGIS Online aboneliğiniz vardır: Barındırılan bir detay servisi kullanmak en iyi seçeneğinizdir. Genel fotoğraf paylaşma servisleri gibi, hızlı yüklenen görüntüler oluşturmak için resimlerinizi optimize ederiz ve ArcGIS platformunun tüm yönetim ve veri yönetimi imkanlarına erişiminiz olur.",
