define({
  "viewer": {
    ...
    "builderHTML": {
      ...
      "buttonOrganizeAndCover": "Tur noktalarını düzenleyin ve bir kapak sayfası ekleyin",
      "buttonAdd": "Ekle",
      "buttonImport": "İçe Aktar",
      "buttonImportDisabled": "Görüntü yükleme kullanılırken içe aktarma kullanılamaz. Bir görüntü yüklemek için lütfen Ekle seçeneğine tıklayın.",
      "dataEditionDisabled": "Veri düzenleme bu CSV veri kaynağında devre dışıdır",
      "dataSourceWarning": "Harita Turu veri katmanı değiştirildi. Ayrıntı kimlikleri aynı değilse, <b>Düzenle</b> yoluyla düzeni ve gizli noktaları sıfırlamanız gerekir. Alan adları farklıysa, <b>Ayarlar’daki veri sekmesi</b> altında alanların ayarlarını sıfırlamanız gerekir.",
      ...
      "dataPicError4": "Bu, desteklenmeyen görüntünün URL’sinin sonuna <i>#isImage</i> ekler. Çoğu sunucu URL eklerini destekler. Ancak, bu işlemi gerçekleştirdiğinizde, noktalarınız arasında gezinerek güncellenen görüntü URL’lerinin çalıştığını doğrulamanız gerekir. Tüm fotoğraflar yükleniyorsa, Harita Turu’nu kaydedebilirsiniz. <b>Görüntüler bozuksa Harita Turu’nu kaydetmeyin</b>. Bunun yerine, oluşturucuyu yeniden yükleyin ve ikinci işlemi gerçekleştirin.",
      "dataPicError5": "Turu resimlerle sınırla",
      "dataPicError6": "Bu seçenek, tüm URL’lerin görüntü olarak nitelendirilmesine neden olur. Ancak, etkileşimli oluşturucuyu kullanarak video ekleyemezsiniz. Daha sonra video eklemeye karar verirseniz bu işlem tersine çevrilebilir.",
      "dataPicError7": "Harita Turu’nuz fotoğraflarla sınırlı; videolar kullanılamaz. Bu sınırlamayı kaldırmak isterseniz, Harita Turu’nu kaydetmeden önce görüntülerinizin hala doğru yüklendiğinden emin olun. Gerekirse, bu sınırlamayı daha sonra tekrar koyabilirsiniz.",
      "dataPicError8": "Resim sınırlamasını kaldır",
      "dataPicError9": "Bu URL’ler videoları belirtiyorsa bu uyarıyı görmezden gelebilirsiniz. Görüntüleri belirtiyorlarsa, aşağıdaki iki işlemden birini gerçekleştirmeniz gerekir:",
      "modalCancel": "İptal",
      "modalApply": "Uygula",
      ...
      "settingsLayoutSidePanel": "Yan Bölme",
      "settingsLayoutSelected": "Seçili düzen",
      "settingsLayoutNew": "Yeni!",
      "settingsLayoutSelect": "Seç",
      "settingsLayoutNote": "Videoları kullanan noktalarda, seçenek işaretli olmasa bile başlığın her zaman videonun altına yerleştirileceğini unutmayın.",
      ...
      "settingsExtentExplain": "Harita Turu ana sayfa kapsamını aşağıdaki etkileşimli haritaya ayarlayın.",
      "settingsExtentExplainBottom": "Tanımladığınız kapsam, haritanızın ana sayfa kapsamını değiştirir. İlk tur noktasını içermiyorsa bu kapsamın kullanılmayacağını unutmayın. Bu durumda tur, ilk noktaya odaklanmış olarak açılır.",
      ...
      "dataExplainPortal": "Detay Katmanı başarılı bir şekilde oluşturulamadıysa lütfen ArcGIS yöneticinizle iletişim kurun.",
      ...
      "coverPreview": "Kapak fotoğrafını görmek için hikayenizi kaydedin ve ardından Hikayeyi Görüntüle düğmesini kullanarak inceleyin.",
    ...
    "addPopupJS": {
      ...
      "errorInvalidPicUrl": "Geçerli bir görüntü URL’si girin. https ile başlamalıdır. jpg, png, gif veya bmp ile bitmelidir. Ya da bu kuralı geçersiz kılmak için URL’yi '#isImage' ile bitirin.",
      "errorInvalidThumbUrl": "Geçerli bir küçük resim (https:// ile başlayan; jpg, png, gif veya bmp ile biten) girin.",
      "errorInvalidVideoUrl": "Geçerli bir video URL’si (https:// ile başlayan) girin",
    ...
    "builderJS": {
      ...
      "closeWithPendingChange": "İşlemi onaylamak istediğinizden emin misiniz? Değişiklikleriniz kaydedilmeyecek.",
      "gotIt": "Tamam",
    ...
    "headerJS": {
      "editMe": "Beni düzenle!",
      "templateTitle": "Başlığı ayarla",
      "templateSubtitle": "Alt başlığı ayarla",
      "edit": "Düzenle"
    },
    "crossFaderJS": {
    ...
    "onlinePhotoSharingCommon": {
      ...
      "locExplain": "Albümden devralındığı ve tüm fotoğrafların aynı konumda olmasıyla sonuçlanacağı olacağı için görüntü konumlarını kullanmak istemeyebilirsiniz.",
      "locExplain2": "Kullanıcı ayarlarından devralındığı ve tüm videoların aynı konumda olmasına neden olacağı için video konumlarını kullanmak istemeyebilirsiniz."
    },
    "viewFlickr": {
      "title": "Flickr'dan içe aktarma",
      "header": "Flickr kullanıcı adınızı girin ve içe aktarılacak bir Albüm veya Etiket seçin.",
      ...
      "footerImportSet": "Seçilen Albümü içe aktar"
    },
    "viewFacebook": {
    ...
    "viewPicasa": {
      "title": "Google+ içe aktar",
      "header": "E-posta adresinizi veya kimliğinizi girin.",
      "userInputLbl": "E-posta veya Picasa/Google+ ID",
      "signInMsg2": "Hesap bulunamadı",
      "signInMsg3": "Genel albüm yok",
      "howToFind": "<a href='https://links.esri.com/storymaps/google-photos-help' target='_blank'>Daha Fazla Bilgi Edinin</a>",
    ...
    "viewCSV": {
      ...
      "errorFieldsExplain": "Aşağıdaki gerekli alanlar bulunmadığından yükleme başarısız oldu",
      ...
      "resultFieldsNotAll": "Harita katmanında bulunmadıklarından aşağıdaki öznitelikler içe aktarılmadı",
    ...
    "viewGeoTag": {
      ...
      "header": "Konumu belirlenen ögeler içe aktarılacak. Konumlarını belirlemek için aktarmak istediğiniz konumu belirlenemeyen ögelere tıklayın.",
      "headerMore": "Yardım",
      "headerExplain": "<b>İçe Aktar</b> düğmesine tıkladığınızda, yalnızca <b>Konumu Belirlenen</b> sekmesi altındaki görüntüler ve videolar içe aktarılır.<br><br>Erişilebilir olmaları halinde, görüntüler veya videolarla birlikte saklanan coğrafi konum bilgileri otomatik olarak içe aktarılır. Coğrafi konumu olmayan ögeler, <b>Konumu Belirlenecek</b> sekmesi altıda listelenir. Bu sekmede listelenen bir ögenin konumunu belirlemek için ögeye tıklayın ve harita üzerinde istediğiniz yere tıklayın.<br><br>İçe aktarılmaması amacıyla bir ögeyi <b>Konumu Belirlenen</b> sekmesinden çıkarmak için, imleci bu öge üzerinde gezdirdiğinizde göreceğiniz İçe Aktarma düğmesine tıklayın.<br><br>İpucu: Medyanızın coğrafi konum bilgileri içe aktarılmıyorsa, hesabınızın gizlilik ayarlarını kontrol edin. Örneğin, Flickr hesap ayarlarınızda EXIF verilerinin gizli olmadığından emin olun. Ayrıca, yeni yüklemeler için Flickr’ın EXIF verilerinin içe aktarılması gizlilik seçeneği kapalıysa (varsayılan), siz tekrar yüklemedikçe veya Flickr’da manuel olarak konumlarını belirtmedikçe görüntülerinizin coğrafi konumu Flickr’da saklanmaz.",
      "leftPanelTab1": "Bulunacaklar",
      "leftPanelTab2": "Bulunanlar",
      "clickOrTap": "Konumu belirlemek için Harita’ya tıklayın",
    ...
    "helpPopup": {
      ...
      "tab1": {
        ...
        "mtFAQ": "Bkz. <a href='https://storymaps.arcgis.com/en/faq/#category4' target='_blank'>Harita Turu SSS.</a>",
      ...
      "tab4": {
        ...
        "div1": "Görüntüler",
        "div2": "Bir Harita Turu’nda farklı boyut, şekil ve yöndeki görüntüler kullanılabilmesine rağmen, dikey görüntüler yerine yatay görüntüleri öneririz. En uygun olanlar, 4:3 en boy oranına sahip görüntülerdir. Başlık ile görüntünün üst üste bindiği Üç Panelli ve Entegre şablonlarda dikey görüntüler kullanılması, görüntünün büyük bir kısmının başlık altında kalmasına neden olabilir. Üç Panelli ve Entegre şablonlarda, mümkünse tüm görüntüler için aynı boyut ve şekli kullanmanızı öneririz. Böylece, tur sırasında kullanıcıların dikkati, farklı boyutlardaki görüntüler nedeniyle dağılmaz.",
        ...
        "div4aa": "<b>Yan Panel turunuz için bir kapak sayfası oluşturun</b><br>Yan Panel şablonu, isteğe bağlı bir kapak sayfasını destekler. Böylece, mükemmel görünen tam ekran bir görüntüyle izleyicilerinizin dikkatini çekersiniz. Yan Panel turuna bir kapak sayfası yapılandırmak için, öncelikle noktalarınızın bazılarını veya tamamını turunuza ekleyin. Ardından Düzenle düğmesine tıklayın ve açılan iletişim penceresinde, kapak sayfasını tanımlamak için kullanacağınız tur noktasının, turunuzdaki ilk nokta olduğundan emin olun. Ardından, bu iletişim penceresinde 'İlk noktayı bir kapak sayfası olarak kullan' seçeneğine tıklayın. İlk tur noktanızın adı kapak sayfasında gösterilen başlık, bu noktanın başlığı ise alt başlık olur ve bu noktanın görüntüsü kapak sayfası görüntüsü olarak kullanılır. Kapak sayfasında video desteklenmez. Daha fazla bilgi için bkz. <a href='https://links.esri.com/storymaps/faq_map_tour_cover_page_sp' target='_blank'>SSS</a>.</a>",
        "div4a": "Turunuz için uygun altyazı yazın",
        "div4b": "Turunuza ilgi çekici bir alt başlık yazmak için zaman ayırın. Alt başlık, insanları turunuza çekmek ve içinde neler keşfedeceklerini anlatmak için iyi bir yoldur. Ayrıca, seyircinize turun yapıldığı bölge veya ülke hakkında bilgi vermek için iyi bir seçenektir. Örneğin, insanların turunuzun gerçekleştiği şehir veya kasabanın yerini bilmediğini varsayın. Alt başlığı fazla uzun tutmayın. Aklınıza iyi bir alt başlık gelmezse boş bırakın. Üç Panelli ve Entegre şablonların aksine Yan Panel şablonu, üst bilgide alt başlığı desteklemez. Yan Panel şablonunda kapak sayfası seçeneğini kullanıyorsanız, turunuzdaki ilk noktanın başlığı kapak sayfasında görüntülenir ve turunuzun alt başlığı görevi görür.",
        "div5": "Katmanları Destekleme",
        "div6": "Harita Turu’na içerik sağlamak için destekleyici katmanlar ekleyebilirsiniz. Bu katmanlar; Harita Turu noktalarına ek olarak haritanın göstermesini istediğiniz, bir çalışma alanı, tur noktalarınızı birleştiren bir yürüyüş veya sürüş rotası gibi diğer coğrafi detayları içerebilir. Harita Turu şablonu, bu destekleyici ek katmanları, web haritasında belirlediğiniz sembolojiyi kullanarak gösterir. Ancak, katmanlar için tanımlanan açılır pencereler desteklenmez. Turunuza destekleyici katmanlar eklemek için çalışmanızı kaydedin ve Harita Turu Oluşturucu’yu kapatın. Ardından, turunuzda kullanılan web haritasını açın. Bu haritayı, ArcGIS İçeriğim altında veya Story Maps web sitesinin Hikayelerim bölümünde bulabilirsiniz.",
        ...
        "div12": "Harita turunun, turun mobil cihazlarda kullandığı ile aynı olan hassas küçük ekran görünümüne geçmesine neden olan dar bir iFrame genişliği kullanmaktan kaçının. Bir harita turu oluştururken, kullanım kolaylığını en üst seviyeye çıkarmak amacıyla kullanıcıların turu tam ekran olarak başlatabilmesi için gömülü turun yanında bir bağlantı sağlamanızı öneririz."
      },
      "tab5": {
        "title": "Yayınlama",
    ...
    "share": {
      ...
      "manageStoryA1": "İpucu: Hikayenizdeki hataları kontrol etmek, paylaşılma şeklini değiştirmek, sosyal medyada güzel görünmesini sağlamak vb. için %LINK1% bağlantısını kullanabilirsiniz. Hikayelerim hakkında daha fazla bilgi edinin %LINK2%.",
      "manageStoryA1V1": "Hikayelerim",
      "manageStoryA1V2": "buraya",
