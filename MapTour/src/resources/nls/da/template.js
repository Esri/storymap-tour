  ...
  "viewer": {
    ...
    "helpPopup": {
      ...
      "tab2": {
        ...
        "div11": "Hvis du vælger at \"hoste\" dine billeder på din egen webserver (i stedet for at have billederne på Flickr eller overføre dem direkte til din tour), skal du manuelt oprette miniaturebilleder af dine billeder. Hvis du bruger billeder i fuld opløsning til miniaturebillederne, bliver de ikke gode. Se disse <a href='https://links.esri.com/storymaps/faq_maptour_image_size' target='_blank'>FAQ</a> for at få tips til at tilpasse størrelsen på dine billeder, hvis du benytter dem på nettet direkte via URL’er.",
        "div12": "Bruge eksisterende steddata",
        "div13": "Hvis du har eksisterende steddata, såsom en liste over steder i et regneark eller et GIS-punktlag, kan du benytte disse data i CSV-format til at oprette en Map Tour. Dette kræver, at dine billeder kan tilgås direkte via URL'er, der er gemt som værdier i CSV-filen. Du kan hente CSV-skabelonen fra dialogboksen Avancerede indstillinger, når du starter Map Tour builder-programmet for første gang. Din CSV-fil kan uploades til denne dialogboks.",
        ...
        "div174": "Se denne <a href='https://links.esri.com/storymaps/faq_map_tour_gis_data' target='_blank'>FAQ</a> for at få flere oplysninger.",
        ...
        "div21": "Hvis du benytter billeder på Flickr, får din Map Tour automatisk adgang til disse billeder som .jpg-filer. Hvis du overfører billeder til Map Tour builder-programmet, skal billederne være i formaterne .jpg eller .jpeg. Hvis du henviser til billeder direkte på internettet via deres URL’er, understøttes billedformaterne .jpg, .jpeg, .png, .gif og .bmp. YouTube-videoer understøttes direkte.",
