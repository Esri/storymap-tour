	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Map Tour-builder-programmet understøttes ikke ved denne skærmstørrelse.",
			...
			builderHTML: {
				...
				dataExplainPortal: "Dette objekt kræver Portal for ArcGIS 10.4. Hvis det ikke lykkes at oprette vektorlaget, skal du kontakte din ArcGIS-administrator.",
			...
			initPopupHome: {
				...
				hostedFsNA2: "Kun tilgængelig for ArcGIS Online for Organizations-medlemmer, <a href=\'%LINK%\'>Tilmeld dig et gratis prøveabonnement</a>",
