	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Žemėlapių turo kūrimo priemonė nepalaiko šio ekrano dydžio.",
			...
			builderHTML: {
				...
				dataPicError6: "Šis pasirinkimas lems tai, kad visi URL bus laikomi nuotraukomis, tačiau tuomet negalėsite pridėti vaizdo įrašų naudodami interaktyvų kūrėją. Šis veiksmas yra grįžtamas, jei nuspręstumėt pridėti video ateityje.",
				dataPicError7: "Jūsų žemėlapio turas buvo apribotas iki nuotraukų, vaizdo įrašai negali būti naudojami. Jei pasirinksite pašalinti šį ribojimą, prieš išsaugodami žemėlapio turą patikrinkite ar Jūsų nuotraukos dar vis užkraunamos. Jei reikės, jūs galėsite atkurti šį apribojimą.",
				dataPicError8: "Pašalinti nuotraukų apribojimą",
				dataPicError9: "Jei šie URL nurodo į vaizdo įrašus, galite ignoruoti šį įspėjimą. Jei jie nurodo nuotrauką, galite atlikti vieną iš šių dviejų veiksmų:",
				...
				dataExplain: "Jūsų atvaizdams ir turo taškams bus sukurtas naujas objektų sluoksnis. Turo sluoksnio nebus galima bendrinti su niekuo, nebent bendrinsite žemėlapių turą.",
				dataExplainPortal: "Šiai funkcijai būtina Portal for ArcGIS 10.4. Jeigu nesiseka kurti objektų sluoksnio, susisiekite su savo ArcGIS administratoriumi.",
			...
			addPopupJS: {
				...
				errorInvalidVideoUrl: "Įveskite veikiantį vaizdo įrašo URL (prasidedantį http(s)://)",
			...
			onlinePhotoSharingCommon: {
				...
				locExplain2: "Galite nenaudoti vaizdo įrašų vietų, kadangi jos gali būti paveldėtos iš vartotojo nustatymų ir dėl to visi video gali būti toje pačioje vietoje."
			},
			viewFlickr: {
			...
			viewGeoTag: {
				...
				headerMore: "Kodėl mano nuotraukos/vaizdo įrašai nerasti?",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "Įkelkite savo atvaizdus ir saugokite juos žemėlapių turo sluoksnyje (vaizdo įrašai nepalaikomi).",
				...
				hostedFsNA2: "Galima tik ArcGIS Online for Organizations nariui, <a href=\'%LINK%\'>Prisiregistruokite, kad galėtumėte išbandyti nemokamai</a>",
			...
			helpPopup: {
				...
				tab2: {
					...
					div21: "Palaikomi nuotraukų formatai yra: <b>.jpg, .jpeg, .png, .gif and .bmp</b>. Jei jūsų medija nesibaigia vienu šių plėtinių, žemėlapio turas laikys ją vaizdo įrašu, išskyrus tuos atvejus, kai naudojama elementų paslauga (žiūrėti žemiau).",
			...
			share: {
				...
				firstSaveHeader: "Šis turas saugomas ArcGIS Online. Prašom perskaityti šiuos atsakymus į dažniausius klausimus.",
