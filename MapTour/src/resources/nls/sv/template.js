	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				noLayerMobile: "Map Tour-byggverktyget går inte att använda med den här skärmstorleken.",
			...
			initPopupHome: {
				...
				hostedFSTooltip: "Överför dina bilder och lagra dem med Map Tour-lagret (stöder inte video).",
				...
				hostedFsNA2: "Endast tillgängligt för medlemmar av ArcGIS Online for Organizations: <a href=\'%LINK%\'>Logga in för en kostnadsfri provperiod</a>",
