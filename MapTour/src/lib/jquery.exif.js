 ...
 *
 * Esri 01/2013
 * - commented out line 194 for IIS : oHTTP.setRequestHeader("If-Modified-Since"
 * - made variable BinaryFile and EXIF global (line 14 and 243)
 * - disabled loading of exif information when document is ready with exif="true" tag (line 862)
 * - return exif data to callback function when used from an image tag (line 557)
 */
...
function getImageData(oImg, fncCallback) 
{
	BinaryAjax(
		...
		function(oHTTP) {
			...
			oImg.exifdata = oEXIF || {};
			if (fncCallback) fncCallback(oImg.exifdata);
		}
	)
}
