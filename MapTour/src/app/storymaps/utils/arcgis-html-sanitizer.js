...
var Sanitizer = /** @class */ (function () {
    function Sanitizer(filterOptions, extendDefaults) {
        ...
        this._xssFilter = new xss__WEBPACK_IMPORTED_MODULE_1___default.a.FilterXSS(xssFilterOptions);
    }
    /**
     ...
     * @memberof Sanitizer
     */
    Sanitizer.prototype.sanitize = function (value) {
        switch (typeof value) {
            case 'number':
     ...
     * @memberof Sanitizer
     */
    Sanitizer.prototype.validate = function (value) {
     ...
     * @memberof Sanitizer
     */
    Sanitizer.prototype._iterateOverObject = function (obj) {
        var _this = this;
        try {
            ...
            if (Array.isArray(obj)) {
                changedObj = obj.reduce(function (prev, value) {
                    var validation = _this.validate(value);
            ...
            else if (!lodash_isplainobject__WEBPACK_IMPORTED_MODULE_0___default()(obj)) {
                return null;
            }
            else {
...
//# sourceMappingURL=arcgis-html-sanitizer.js.map