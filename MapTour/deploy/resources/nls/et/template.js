...
({
		viewer: {
			...
			builderHTML: {
				...
				dataPicError2: "Nõue ei mõjuta teie eksisteerivat publitseeritud kaardituuri, kuid interaktiivse looja kasutamiseks peate esmalt lahendama aadesssi küsimused tehes ühte järgnevatest tegevustest:",
				dataPicError3: "Muuda aadresse",
				dataPicError4: "See lisab <i>#isPicture</i> mitte toetatud piltide aadresside lõppu. Enamik servereid toetab aadressi täiendeid. Kuid peale selle tegevuse sooritamist kontrollige punktide vahel navigeerides, et uuendatud piltide aadressid on funktsioneerivad. Kui kõik pildid laevad ilusti, siis võite salvestada kaardituuri. Kui <b>pildid on katki, ärge salvestage kaardituuri</b>. Selle asemel laadige looja uuesti ning teostage teine tegevus.",
				...
				addNoteVideo: "Videote kasutamiseks tutvu Abiga",		
				...
				dataExplain: "Objektiteenus lisatakse sinu veebikaardile. Seda ei jagata kõigiga ning ainult sinul on õigus andmeid lisada, muuta ja kustutada. <br /><br /> Kui sa rakenduste jagamise õigusi muudad, küsib Süsteem sinult, kas soovid uuedada objektiteenuse jagamise õigusi. See on vajalik selleks, et sinu kasutajatel oleks ligipääs sinu andmetele. Õigus andmeid muuta on endiselt ainult sinul.",
			...
			addPopupJS: {
				...
				errorInvalidPicUrl: "Sisesta korrektne pilt (algab http(s)://, lõppeb jpg, png, gif või bmp). Võte pildi aadressi lõppu lisada '#isPicture', mis on eelneva reegli ülene.",
			...
			onlinePhotoSharingCommon: {
				...
				header1: "Pildid peavad olema avalikult jagatud.",
				header2: "Importimine on limiteeritud %NB1% pildini, et hoida piiri %NB2% punkti tuuri kohta.",
			...
			viewFlickr: {
				header: "Sisesta Flickri kasutajanimi ja vali fotokogum või märksõna, mida soovid importida.",
			...
			viewFacebook: {
				header: "Tuvasta isik Facebooki kasutajanimega või kasuta avalikku lehte. Privaatseid albumeid saab kasutada avaliku kaardi tuuri tegemisel, mis ei eelda isiku tuvastamist Facebooki kasutajanimega, mis võimaldab hoida kommentaare ja meeldimisi privaatsena.",
			...
			viewGeoTag: {
				header: "Klikka või koputa piltidele, mida soovid nende paigutamiseks importida.",
				...
				footerSucceed: "Importimine õnnestus. Laadin...",
				loading: "Laen",
				error: "Piltide asukohtade import ebaõnnestus, asukohti ignoreeriti."
			},
			initPopup: {
			...
			initPopupHome: {
				header2: "See nõustaja abistab sind kaardi tuuri loomisel, kasutades selleks  kas veebis olemasolevaid pilte või importides pildid sinu ArcGIS Online for Organization kontole.",
				title1: "Minu pildid on juba majutatud",
				title2: "Mul on vaja oma pilte majutada",
				hostedFsNA: "Kättesaadav ainult nendele ArcGIS for Organization kasutajatele, kellel on avaldaja ja administraatori õigused.",
				footer1: "Kui oled valmis, ära unusta oma kaarti rakenduste lehe kaudu teistega jagada.",
				footer2: "Kaardi tuuri abi",
			...
			helpPopup: {
				...
				tab1: {
					...
					div2: "Malli loob atraktiivse ja lihtsasti kasutatava veebirakenduse, mille abil saate väikesel hulgal paiku numbrilises järjestuses kaardil esitada. Mall on välja töötatud mistahes tüüpi veebibrauseris või nutiseadmes kasutamiseks.",
					div3: "Antud abifail hõlbustab kaardi tuuri avaldamist, nt:",
					...
					div5: "Ootame tagasisidet! Jaga loodud kaardituuri meiega:",
					...
					div7: "Leidsid bugi või tekkis isu uute funktsioonide järelei? Anna tagasisidet vastava teema kohta <a href='https://github.com/Esri/map-tour-storytelling-template-js' target='_blank'>GitHub projekti leht</a>."
				},
				tab2: {
					title: "Andmed",
					...
					div14: "Vajalikud veerud on (tõstutundlikud):",
					div151: "Nimi",
					div152: "Kirjeldus",
					div153: "Pilt",
					div154: "Pisipilt",
					div155: "Värv (valikuline)",
					div16: "Nime ja kirjelduse veerud on esmatähtsad. Kui rakendus ei leia objektiteenusest sobivaid veerge, siis vaateaken ei toimi seni, kuni veerud tekivad. CSV ja shapefile kihi lisamine veebikaardile eeldab kõiki vajalikke veerge, sest vastasel korral rakenduse koostamine ei toimi.",
					...
					div173: "Näidis CSV ja shapefile saab alla laadia asukohast",
					div18: "Koostan majutatud objektiteenuse CSV või shapefaili",
				...
				tab4: {
					...
					div0a: "Kaardituuri vaataja on toetatud IE8+. Interaktiivne looja on toetatud IE9+. Me aktiivselt testime kõikidel enam levinud veebibrauseritel aga kui teil on tõrkeid, siis soovitame kasutada Chrome veebibrauserit.",
					div0b: "Kui teil esineb tõrkeid, siis andke palun meile teada. Vahepeal proovige CSV malliga oma kaardituuri luua, nii vähendate oma suhtluse interaktiivse looja keskkonnaga minimaalseks.",
					div1: "Pildid",
					div2: "Soovitame kasutada horisontaalset paigutust. Vertikaalpaigutus ei sobi väiksemate ekraanide korral nagu iPad,  pilt võib selgitava teksti varju jääda, sest tekst võtab rohkem ruumi, kui see kuvatakse kitsal ja mitte laial alal. Kuigi erinevate suuruste, kujude ja paigutusega pilte võib ühe ja sama kaardi tuuri loomisel kasutada, soovitame kasutada täpselt sama suurust ja vormi kõigi piltide korral. Sellisel juhul on kasutajal infot lihtsam jälgida.",
					div2a: "Kui majutate oma pilte ise, siis soovitame maksimaalseks resolutsiooniks <b>1090x725</b> piltidele ja <b>140x93</b> piltide eelvaadetele.",
					...
					div7: "Hoia tuur lühida ja löövana",
					div8: "Ühes tuuris võib olla kuni 99 punkti. Enamik tuure on loomulikult lühemad. Ära oota, et külastajad on valmis läbi käima liiga arvukalt tuuripunkte. Sinu arvates võib teema olla äärmiselt huvitav, kuid ära eelda, et nemad sinuga nõustuvad!",
				...
				tab5: {
					title: "Publitseerin",
					div1: "Kui oled valmis, ära unusta tulemust jagada suurema auditooriumiga ArcGIS Online rakenduse kaudu. Selle protsessi käigus võib ArcGIS Online vajaduse korral paluda mistahes seotud ressursi (veebikaart, objektiteenus) uuendamist, kui see ei ole jagatud sarnasel viisil. Kui kaardituur on avalik ja üks nendest ressurssidest ei ole jagatud kogu auditooriumiga, suunatakse kasutajad ArcGIS Online sisselogimise lehele.",
					div2: "Kui kasutate kaardi tuuri koostaja kaudu loodud majutatud objektiteenust, haldab rakendus teenuse turvalisust Teie eest ning Teie jääte ainsaks muutmisõigustega kasutajaks (ka juhul, kui teenus on avalik).",
					div3: "Enne kaardi tuuri avalikuks muutmist veendu, et see toimib ka siis, kui sa ei ole  ArcGIS.com kontole sisse logitud.",
					div4: "Kasulik on vaadata, kuidas kaardi tuur paistab iPad horisontaalpaigutuses. Selle kaudu saate parema ülevaate, millal piltide hulk ekraanil tundub liiga suur."
				}
			}
        }
    })
